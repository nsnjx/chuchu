...
RelayDBISAR _relayDBInfoFromMap(Map<String, dynamic> map) {
  return RelayDBISAR(
    ...
    friendRequestSince: (map['friendRequestSince'] as num?)?.toInt() ?? 0,
    friendRequestUntil: (map['friendRequestUntil'] as num?)?.toInt() ?? 0,
    friendMessageSince: (map['friendMessageSince'] as num?)?.toInt() ?? 0,
    friendMessageUntil: (map['friendMessageUntil'] as num?)?.toInt() ?? 0,
    channelMessageSince: (map['channelMessageSince'] as num?)?.toInt() ?? 0,
    channelMessageUntil: (map['channelMessageUntil'] as num?)?.toInt() ?? 0,
    commonMessagesSince: (map['commonMessagesSince'] as num?)?.toInt() ?? 0,
    commonMessagesUntil: (map['commonMessagesUntil'] as num?)?.toInt() ?? 0,
    groupMessageSince: (map['groupMessageSince'] as num?)?.toInt() ?? 0,
    groupMessageUntil: (map['groupMessageUntil'] as num?)?.toInt() ?? 0,
    mlsGroupMessageSince: (map['mlsGroupMessageSince'] as num?)?.toInt() ?? 0,
    mlsGroupMessageUntil: (map['mlsGroupMessageUntil'] as num?)?.toInt() ?? 0,
    momentSince: (map['momentSince'] as num?)?.toInt() ?? 0,
    momentUntil: (map['momentUntil'] as num?)?.toInt() ?? 0,
    zapRecordSince: (map['zapRecordSince'] as num?)?.toInt() ?? 0,
    zapRecordUntil: (map['zapRecordUntil'] as num?)?.toInt() ?? 0,
